...
First, we will compute the moments  $m_k:=\langle x^k, \SC\rangle$ of the
...
$\lim_{N\to\infty}\EE \langle x^k,L_N\rangle \to m_k$ for each $k$. The third
step is to show that  the variance of $\langle x^k,L_N\rangle$ goes to zero as
