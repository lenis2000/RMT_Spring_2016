...
\end{align*}
See Fig.~\ref{fig:pair_partitions_NC_partitions}.
\begin{figure}[htbp]
		\begin{tikzpicture}
...
\begin{definition}[Free convolution]\label{def:free_convolution}
	...
	\end{align*}
	As we will see below, the definition of the free convolution operation 
...
identically distributed elements of $(\mathcal{A},\tau)$, then
\begin{equation*}
...
\begin{equation}\label{free_clt_moment_convergence}
	...
	\end{cases}
\end{equation}
This is proven using free cumulants exactly in the same way as 
the classical Central Limit Theorem (Theorem \ref{thm:classic_clt}).
