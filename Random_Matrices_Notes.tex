...
\end{remark}
\begin{remark}
	Because all partitions are non-crossing for $n\leq 3$, we have
	 \begin{align*}
	     c_1& =k_1,\\
	     c_2& =k_2,\\
	     c_3& =k_3.
...
The geometrically connectedness condition leads to splitting into noncrossing partitions.
...
\note{mixed cumulants here}

% subsection free_independence (end)

\subsection{Free random variables} % (fold)
